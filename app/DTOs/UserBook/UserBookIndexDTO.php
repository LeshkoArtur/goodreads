...
/**
 * DTO для фільтрації списку зв’язків між користувачами та книгами.
 */
class UserBookIndexDTO
{
    /**
     * Створює новий екземпляр UserBookIndexDTO.
     *
     ...
     * @param string|null $shelfId Фільтр за ID полиці
     */
