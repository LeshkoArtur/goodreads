...
class LikeIndexRequest extends FormRequest
{
    ...
    {
        return $this->user()?->can('viewAny', Like::class) ?? true;
    }
    ...
    public function queryParameters(): array
    {
        return [
            ...
            'likeable_type' => [
                'description' => 'Фільтр за типом об\'єкта лайка. Можливі значення: App\\Models\\Post, App\\Models\\GroupPost, App\\Models\\Quote, App\\Models\\Rating, App\\Models\\Comment, App\\Models\\AuthorAnswer.',
                'example' => 'App\\Models\\Post',
            ],
            'likeable_id' => [
                'description' => 'Фільтр за UUID об\'єкта лайка.',
